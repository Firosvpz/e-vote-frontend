...
import CandidatesModal from "../admin/elections/CandidatesModal"
import { getELectionDetails } from "../../api/user/userApi"

const ElectionDetailsModal = ({ isOpen, onClose, election }) => {
    ...
    useEffect(() => {
        ...
        const fetchPreview = async () => {
            ...
            setError(null)
            try {
                const response = await getELectionDetails(election._id)
    ...
    return (
        <div
            ...
            <div
                className="relative  bg-gradient-to-br from-slate-800/95 to-purple-700/95  rounded-3xl border border-white/20 shadow-2xl  w-full max-w-3xl p-8 max-h-[90vh] overflow-y-auto transform scale-95 data-[state=open]:scale-100 transition-transform duration-300">

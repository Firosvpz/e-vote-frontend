...
const DeleteUserModal = ({ isOpen, onClose, onConfirm, userName, isDeleting = false, error = null }) => {
        ...
        <div className="mb-6">
          <div className="bg-white/5 backdrop-blur-md rounded-xl p-4 border border-white/10 mb-4">
            <p className="text-white/90 mb-2">
              Are you sure you want to delete <span className="font-semibold text-emerald-400">{userName}</span>?
            </p>
          ...
          <div className="bg-white/5 backdrop-blur-md rounded-xl p-4 border border-white/10">
            <div className="flex items-center space-x-3">
              ...
              <div>
                ...
                <div className="text-white/60 text-sm">User will be permanently removed</div>
              </div>
            </div>
          </div>
        </div>

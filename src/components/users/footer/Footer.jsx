 ...
 const socialLinks = [
    {
      ...
      icon: (
        <svg className="w-8 h-8" fill="#64ffda" viewBox="0 0 24 24">
    ...
    },
    {
      ...
      icon: (
        <svg className="w-10 h-10" fill="none" stroke="#64ffda" viewBox="0 0 24 24">
          <path
            strokeLinecap="round"
        ...
        <div className="relative flex flex-col md:flex-row justify-between items-center gap-6 p-6 rounded-2xl border border-white/10 backdrop-blur-xl">
          <div className="flex items-center space-x-6">
            <div className="text-[#64ffda]">
              © {new Date().getFullYear()} vpzfiroz@gmail.com
            </div>
          ...
          <div className="flex items-center">
            <div className="px-4 py-2 bg-transparent  backdrop-blur-sm">
              <span className="text-sm text-[#64ffda]">Connect with me</span>
            </div>
          </div>
        </div>
      </div>
